...
import { Fan, Thermometer, AlertTriangle, PenToolIcon as Tool, Info } from "lucide-react"
...
function MapLegend() {
  return (
    <div className="absolute top-4 right-4 bg-white/90 dark:bg-gray-900/90 p-3 rounded-md shadow-md border">
...
function DataCenterStats({ racks }) {
  ...
  return (
    <div className="absolute bottom-4 left-4 right-4 bg-white/90 dark:bg-gray-900/90 p-3 rounded-md shadow-md border">
      ...
      <Canvas camera={{ position: [0, 5, 10], fov: 50 }}>
        ...
        {racks.map((rack) => (
          <ServerRack
            ...
            fanStatus={rack.fanStatus}
            needsMaintenance={rack.needsMaintenance}
