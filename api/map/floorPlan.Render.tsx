import { Camera, Door, FloorPlanData, Furniture, Wall, Window } from "./floorPlan.types";
...
const drawCamera = (
  ...
  // Draw camera body
  ctx.fillStyle = camera.isActive ? "#007BFF" : "#888888";
  ...
  ctx.fillStyle = camera.isActive ? "#00FF00" : "#FF0000";
  ctx.fill();
